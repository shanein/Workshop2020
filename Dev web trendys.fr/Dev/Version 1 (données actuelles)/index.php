...
while ($id < 500) //prend +de 120 secondes donc on le fait en 2 fois ($id < 900 puis $id = 900 et $id < $max en elevant la supression de la bdd et la reinitialisation de l'auto incremente)
{
...
echo "<br><a href=\"index2.php\">Stocker les données suivantes</a>";
